pipeline {
    ...
    environment {
        ...
        GITHUB_URL = 'https://github.com/valachmr/225-lab3-3.git'      //<-----change this to match this new repository!
        ...
        stage('Deploy to Dev Environment') {
            steps {
                script {
                    ...
                    sh "sed -i 's|cithit/valachmr:.*|cithit/valachmr:${IMAGE_TAG}|g' deployment-dev.yaml"
